...
export default function ViewOrder({
  ...
  let totalPrice = orderDetails.orderItems.reduce(
    ...
    >
      <div
        className=" bg-body rounded-lg text-left
         overflow-hidden shadow-xl transform transition-all min-h-fit max-h-2/3
         sm:my-8 sm:align-middle sm:max-w-lg sm:w-full flex flex-col"
      >
        <div>
          ...
          <div className="pt-2 bg-white flex flex-col gap-2 text-sm">
            ...
            <div className="flex flex-col gap-2">
              ...
              <div className=" px-4 flex justify-between font-semibold">
                <span>Total</span>
                <span>{formatMoney(totalPrice + 200)}</span>
              </div>
