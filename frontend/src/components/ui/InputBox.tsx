...
export default function InputBox({
  ...
  return (
    <div className={`relative `}> {/* Apply classname to the container */}
      <input
        type={type}
        ...
        className={`block w-full ${classname} rounded-sm border-1 px-4 py-2 focus:outline-mayormoto-blue text-sm 
                       border-mayormoto-blue font-normal outline-0 bg-white`}
