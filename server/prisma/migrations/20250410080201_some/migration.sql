-- CreateEnum
CREATE TYPE "EmployeeRole" AS ENUM ('ADMIN', 'CASHIER', 'STOCKER');

-- CreateEnum
CREATE TYPE "PaymentMethod" AS ENUM ('CREDIT_CARD', 'DEBIT_CARD', 'CASH', 'ONLINE');
...
-- AddForeignKey
ALTER TABLE "products" ADD CONSTRAINT "products_addedById_fkey" FOREIGN KEY ("addedById") REFERENCES "users"("id") ON DELETE SET NULL ON UPDATE CASCADE;
